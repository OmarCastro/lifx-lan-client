...
export const Packet = {
  ...
  toObject (buf: Uint8Array) {
    ...
    const obj = {} as StateLocationObject;
    let offset = 0;
    ...
    obj.location = uint8ArrayToHexString(buf.slice(offset, offset + 16))
    offset += 16;
   ...
   */
  toBuffer(obj: StateLocationObject) {
    ...
    buf.set(hexStringToUint8Array(obj.location).slice(0, 16), offset)
    offset += 16;
